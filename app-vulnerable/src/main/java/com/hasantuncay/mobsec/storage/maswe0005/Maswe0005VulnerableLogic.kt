 ...
 */
object Maswe0005VulnerableLogic {
    ...
    fun executeVector(
        ...
        when (vector) {
            ...
            Maswe0005Vector.LOCAL_FILE -> triggerLocalFileLeak(appData, context)
            Maswe0005Vector.SDK_TELEMETRY -> triggerSdkTelemetryLeak(appData)
            Maswe0005Vector.WEBVIEW_CONSOLE -> triggerWebViewConsoleLeak(appData, context)
        }
