...
fun GdprPiiCard(data: GdprPiiData, modifier: Modifier = Modifier) {
    ExpandableDataCard(title = stringResource(id = R.string.card_title_gdpr), modifier = modifier) {
        ...
        ReadOnlyDataField(stringResource(id = R.string.label_tckn), String(data.directIdentifiers.nationalIdentificationNumber.getDataToMask()), isSensitive = true)
        ReadOnlyDataField(stringResource(id = R.string.label_email), String(data.directIdentifiers.personalEmail.getDataToMask()))
