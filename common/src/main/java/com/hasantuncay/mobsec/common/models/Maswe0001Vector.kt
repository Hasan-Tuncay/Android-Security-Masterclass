...
enum class Maswe0001Vector(
    ...
    SHARED_PREFS_PLAINTEXT(
        titleVulnRes = R.string.maswe_0001_vector_shared_prefs_vuln,
        msgVulnRes = R.string.maswe_0001_msg_shared_prefs_vuln,
        icon = Icons.Default.Key
    ),

    DATASTORE_UNENCRYPTED(
        titleVulnRes = R.string.maswe_0001_vector_datastore_vuln,
        msgVulnRes = R.string.maswe_0001_msg_datastore_vuln,
        icon = Icons.Default.DataObject
    ),

    SQLITE_PLAINTEXT(
        titleVulnRes = R.string.maswe_0001_vector_sqlite_vuln,
        msgVulnRes = R.string.maswe_0001_msg_sqlite_vuln,
        icon = Icons.Default.Storage
    ),

    FILE_PROVIDER_ROOT_PATH(
        titleVulnRes = R.string.maswe_0001_vector_file_provider_vuln,
        msgVulnRes = R.string.maswe_0001_msg_file_provider_vuln,
    ...
    CACHE_DIRECTORY(
        titleVulnRes = R.string.maswe_0001_vector_cache_vuln,
        msgVulnRes = R.string.maswe_0001_msg_cache_vuln,
        icon = Icons.Default.FolderSpecial
    ),

    PATH_TRAVERSAL(
        titleVulnRes = R.string.maswe_0001_vector_path_traversal_vuln,
        msgVulnRes = R.string.maswe_0001_msg_path_traversal_vuln,
        icon = Icons.Default.FolderSpecial
    ),

    THIRD_PARTY_SDK_LEAK(
        titleVulnRes = R.string.maswe_0001_vector_sdk_leak_vuln,
        msgVulnRes = R.string.maswe_0001_msg_sdk_leak_vuln,
        icon = Icons.Default.DataObject
    );

    override fun getAdbCommandVuln(resultPath: String?): String {
    ...
    override val screenTitleVulnRes = R.string.maswe_0001_vuln_title
    override val screenDescVulnRes = R.string.maswe_0001_vuln_desc
    override val contextInfoRes = R.string.maswe_context_info
    override val vectorsTitleVulnRes = R.string.maswe_0001_vuln_vectors_title
}
