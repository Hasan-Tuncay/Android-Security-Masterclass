...
enum class Maswe0037Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0037",
            titleRes = CommonR.string.maswe_0037_secure_title,
            descRes = CommonR.string.maswe_0037_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0037_secure_vectors_title
        )
    }
}
