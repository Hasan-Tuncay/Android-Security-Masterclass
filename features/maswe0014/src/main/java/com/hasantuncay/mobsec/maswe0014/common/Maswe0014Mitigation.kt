...
enum class Maswe0014Mitigation(
    ...
    PLAIN_HASH_INSTEAD_OF_KDF(
        titleRes = R.string.maswe_0014_vector_plain_hash_instead_of_kdf_secure,
        msgRes = R.string.maswe_0014_msg_plain_hash_instead_of_kdf_secure,
        icon = Icons.Default.Block
    ),
    INSUFFICIENT_WORK_FACTOR(
        titleRes = R.string.maswe_0014_vector_insufficient_work_factor_secure,
        msgRes = R.string.maswe_0014_msg_insufficient_work_factor_secure,
        icon = Icons.Default.Warning
    ),
    MISSING_OR_PREDICTABLE_SALT(
        titleRes = R.string.maswe_0014_vector_missing_or_predictable_salt_secure,
        msgRes = R.string.maswe_0014_msg_missing_or_predictable_salt_secure,
        icon = Icons.Default.Key
    ),
    LOW_ENTROPY_INPUT(
        titleRes = R.string.maswe_0014_vector_low_entropy_input_secure,
        msgRes = R.string.maswe_0014_msg_low_entropy_input_secure,
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0014",
            titleRes = CommonR.string.maswe_0014_secure_title,
            descRes = CommonR.string.maswe_0014_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0014_secure_vectors_title
        )
    }
}
