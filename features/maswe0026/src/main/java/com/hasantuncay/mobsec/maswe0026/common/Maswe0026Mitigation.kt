package com.hasantuncay.mobsec.maswe0026.common
...
enum class Maswe0026Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0026",
            titleRes = CommonR.string.maswe_0026_secure_title,
            descRes = CommonR.string.maswe_0026_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0026_secure_vectors_title
        )
    }
}
