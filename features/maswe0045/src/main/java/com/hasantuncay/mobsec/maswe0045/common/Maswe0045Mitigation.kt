...
enum class Maswe0045Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0045",
            titleRes = CommonR.string.maswe_0045_secure_title,
            descRes = CommonR.string.maswe_0045_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0045_secure_vectors_title
        )
    }
}
