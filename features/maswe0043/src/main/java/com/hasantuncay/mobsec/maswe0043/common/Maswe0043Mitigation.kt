...
enum class Maswe0043Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0043",
            titleRes = CommonR.string.maswe_0043_secure_title,
            descRes = CommonR.string.maswe_0043_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0043_secure_vectors_title
        )
    }
}
