...
enum class Maswe0017Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0017",
            titleRes = CommonR.string.maswe_0017_secure_title,
            descRes = CommonR.string.maswe_0017_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0017_secure_vectors_title
        )
    }
}
