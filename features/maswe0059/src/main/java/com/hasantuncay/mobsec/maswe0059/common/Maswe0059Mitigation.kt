...
enum class Maswe0059Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0059",
            titleRes = CommonR.string.maswe_0059_secure_title,
            descRes = CommonR.string.maswe_0059_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0059_secure_vectors_title
        )
    }
}
