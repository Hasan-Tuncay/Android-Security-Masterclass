...
enum class Maswe0067Vector(
    ...
    CUSTOM_KEYBOARD(
        titleRes = R.string.maswe_0067_vector_vuln,
        msgRes = R.string.maswe_0067_msg_vuln,
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0067",
            titleRes = CommonR.string.maswe_0067_vuln_title,
            descRes = CommonR.string.maswe_0067_vuln_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0067_vuln_vectors_title
        )
    }
}
