...
enum class Maswe0071Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0071",
            titleRes = CommonR.string.maswe_0071_secure_title,
            descRes = CommonR.string.maswe_0071_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0071_secure_vectors_title
        )
    }
}
