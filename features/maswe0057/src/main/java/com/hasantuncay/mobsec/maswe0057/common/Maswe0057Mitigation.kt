...
enum class Maswe0057Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0057",
            titleRes = CommonR.string.maswe_0057_secure_title,
            descRes = CommonR.string.maswe_0057_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0057_secure_vectors_title
        )
    }
}
