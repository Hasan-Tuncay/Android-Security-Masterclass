...
enum class Maswe0058Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0058",
            titleRes = CommonR.string.maswe_0058_secure_title,
            descRes = CommonR.string.maswe_0058_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0058_secure_vectors_title
        )
    }
}
