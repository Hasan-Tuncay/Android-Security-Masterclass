...
enum class Maswe0046Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0046",
            titleRes = CommonR.string.maswe_0046_secure_title,
            descRes = CommonR.string.maswe_0046_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0046_secure_vectors_title
        )
    }
}
