...
enum class Maswe0031Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0031",
            titleRes = CommonR.string.maswe_0031_secure_title,
            descRes = CommonR.string.maswe_0031_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0031_secure_vectors_title
        )
    }
}
