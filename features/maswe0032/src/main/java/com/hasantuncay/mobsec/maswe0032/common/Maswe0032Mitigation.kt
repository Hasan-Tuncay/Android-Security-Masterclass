...
enum class Maswe0032Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0032",
            titleRes = CommonR.string.maswe_0032_secure_title,
            descRes = CommonR.string.maswe_0032_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0032_secure_vectors_title
        )
    }
}
