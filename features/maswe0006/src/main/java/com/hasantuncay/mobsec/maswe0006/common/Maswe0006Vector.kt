...
enum class Maswe0006Vector(
    ...
    AUTOMATIC_SYSTEM_BACKUP(
        titleRes = R.string.maswe_0006_vector_auto_backup_vuln,
        msgRes = R.string.maswe_0006_msg_auto_backup_vuln,
        icon = Icons.Default.CloudOff
    ),

    LOCAL_BACKUP(
        titleRes = R.string.maswe_0006_vector_local_backup_vuln,
        msgRes = R.string.maswe_0006_msg_local_backup_vuln,
        icon = Icons.Default.FolderOpen
    ),

    DEVICE_TO_DEVICE_TRANSFER(
        titleRes = R.string.maswe_0006_vector_d2d_transfer_vuln,
        msgRes = R.string.maswe_0006_msg_d2d_transfer_vuln,
        icon = Icons.Default.DeviceUnknown
    ),

    UNENCRYPTED_BACKUP_DATA(
        titleRes = R.string.maswe_0006_vector_unencrypted_backup_vuln,
        msgRes = R.string.maswe_0006_msg_unencrypted_backup_vuln,
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0006",
            titleRes = CommonR.string.maswe_0006_vuln_title,
            descRes = CommonR.string.maswe_0006_vuln_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0006_vuln_vectors_title
        )
    }
}
