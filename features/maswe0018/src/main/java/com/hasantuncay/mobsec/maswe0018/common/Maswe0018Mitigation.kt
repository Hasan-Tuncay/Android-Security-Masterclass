...
enum class Maswe0018Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0018",
            titleRes = CommonR.string.maswe_0018_secure_title,
            descRes = CommonR.string.maswe_0018_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0018_secure_vectors_title
        )
    }
}
