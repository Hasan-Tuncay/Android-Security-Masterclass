package com.hasantuncay.mobsec.maswe0004.common
...
enum class Maswe0004Mitigation(
    ...
    companion object {
        val meta = MasweScreenMeta(
            masweId = "MASWE-0004",
            titleRes = CommonR.string.maswe_0004_secure_title,
            descRes = CommonR.string.maswe_0004_secure_desc,
            contextInfoRes = CommonR.string.maswe_context_info,
            itemsTitleRes = CommonR.string.maswe_0004_secure_vectors_title
        )
    }
}
